...
use obelyzk::cairo_serde::{serialize_ml_proof_for_recursive, serialize_proof, MLClaimMetadata};
use obelyzk::compiler::prove::{prove_model, verify_model_matmuls};
use obelyzk::prelude::*;
...
#[test]
#[ignore = "pre-existing: mode 4 aggregated_binding not generated by default `prove_model_pure_gkr` — mode dispatch / setup issue, separate triage"]
fn test_cross_verify_mode4_aggregated_binding() {
    use obelyzk::aggregation::prove_model_pure_gkr;
    use obelyzk::cairo_serde::serialize_aggregated_binding_proof;
    use obelyzk::components::matmul::{matrix_to_mle_col_major_pub, M31Matrix};
    use obelyzk::crypto::aggregated_opening::AggregatedWeightClaim;
